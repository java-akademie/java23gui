		...
		implements ActionListener
{
	...
	private void addErfassungsmaske()
	{
		...
		JLabel lbUeberschr = new JLabel(
				"anzeigen/erfassen/aendern/loeschen");
	...
	private void insert()
	{
		...
		{
			taErg.setText(mdb.tbInsert("", "not numeric", "xxx"));
	...
	private void update()
	{
		...
		taErg.setText(mdb.update(tfId.getText(), tfName.getText(),
				tfAddr.getText()));
